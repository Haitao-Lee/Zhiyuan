# Contributing to Zhiyuan

There are many ways to contribute to Zhiyuan.

- Submit a feature request or bug, or add to the discussion on the [Zhiyuan issue tracker][is]
- Submit a [Pull Request][pr] to improve Zhiyuan.

## The PR Process, and Related Gotchas

### How to submit a PR ?

If you are new to Zhiyuan development and you don't have push access to the Zhiyuan
...
When submitting a PR, make sure to add a `Cc: @Zhiyuan/developers` comment to
notify Zhiyuan developers of your awesome contributions. Based on the
...
- You do NOT have push access: A Zhiyuan core developer will integrate your PR.
...
[pr]: https://github.com/Shanghai Jiao Tong University/Zhiyuan/merge_requests
[is]: https://github.com/Shanghai Jiao Tong University/Zhiyuan/issues
